...
public class RenderHyperthermiaOverlay {
    private static final ResourceLocation SCREEN_OVERLAY_TEXTURE = new ResourceLocation(GSIC2.ASSET_PREFIX, "textures/gui/overlay/hyperthermia_overlay.png");
    ...
    public static void onRenderGameOverlayEvent(RenderGameOverlayEvent.Post event){
        ...
        if(event.getType() == RenderGameOverlayEvent.ElementType.HELMET){
            ...
            if(Minecraft.getMinecraft().player.isPotionActive(ACPotions.overheat)){
