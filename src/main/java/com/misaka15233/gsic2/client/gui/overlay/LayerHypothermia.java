...
public class LayerHypothermia extends LayerTiledOverlay<EntityLivingBase> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(GSIC2.ASSET_PREFIX, "textures/gui/overlay/hypothermia_overlay.png");

    public LayerHypothermia(RenderLivingBase<?> renderer){
        super(renderer);
    }

    @Override
    public boolean shouldRender(EntityLivingBase entity, float partialTicks){
        return !entity.isInvisible() && entity.isPotionActive(ACPotions.hypothermia);
    }
