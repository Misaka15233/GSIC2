...
public class LayerRadiation extends LayerTiledOverlay<EntityLivingBase> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(GSIC2.ASSET_PREFIX, "textures/gui/overlay/radiation_overlay.png");

    public LayerRadiation(RenderLivingBase<?> renderer){
        super(renderer);
    }

    @Override
    public boolean shouldRender(EntityLivingBase entity, float partialTicks){
        return !entity.isInvisible() && entity.isPotionActive(ACPotions.radiation);
    }
